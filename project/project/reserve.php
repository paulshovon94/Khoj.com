							...
							<div class="widget-wrap">
								<div class="single-sidebar-widget search-widget">
									<form class="search-form" method="post" action="reserve.php" >
			                            <input placeholder="restarun name..." name="search" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'restarun name...'" >
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-12 home-about-left">
							...
							$search=$_POST['search'];
							$query="SELECT restaurent_name,menu,area_name,trade_mark_dish,rating,phone_No,address,map,review FROM restaurent WHERE restaurent_name LIKE '%$search%'";
							$result=mysqli_query($db,$query);
							
							if(mysqli_num_rows($result)>0)
							{
								echo "** Call In this appropriate numbers to make reservation";
