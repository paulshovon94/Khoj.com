	...
	<head>
		...
		<link href="https://fonts.googleapis.com/css?family=Poppins:100,200,400,300,500,600,700" rel="stylesheet"> 
			...
			CSS
			============================================= -->
			<link rel="stylesheet" href="project/css/linearicons.css">
			<link rel="stylesheet" href="project/css/font-awesome.min.css">
			<link rel="stylesheet" href="project/css/bootstrap.css">
			<link rel="stylesheet" href="project/css/magnific-popup.css">
			<link rel="stylesheet" href="project/css/lightcase.css">
			<link rel="stylesheet" href="project/css/jquery-ui.css">				
			<link rel="stylesheet" href="project/css/nice-select.css">							
			<link rel="stylesheet" href="project/css/animate.min.css">
		...
		<body>	
				...
				<div class="header-top">
					<div class="container">
				  		<div class="row justify-content-center">
						      <div id="logo">
						        <a href="project/login.php"><img src="project/img/restaurent_cheif_food_hotel_vector_logo.png" alt="" title="" /></a>
						      </div>
				  		</div>			  					
					</div>
				</div>
				<div class="container main-menu">
					<div class="row align-items-center justify-content-center d-flex">			
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          <li><a href="project/login.php">Home</a></li>
				          <li><a href="project/login.php">Gallery</a></li>
				          <li><a href="project/login.php">About</a></li>					           		 <li><a href="project/login.php">Contact</a></li>
				          <li class="menu-has-children"><a href="project/login.php">Log in/ Sign up</a></li>
				        </ul>
						...
						<div class="col-lg-12 banner-content">
							...
							<div class="widget-wrap">
								<div class="single-sidebar-widget search-widget">
									<form class="search-form" method="post" action="project/login.php" >
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 home-about-left">
							...
							<a href="project/login.php" class="primary-btn">view restaurant</a>
						</div>
						<div class="col-lg-6 home-about-right">
							<img class="project/img-fluid" src="img/about-img.jpg" alt="">
						</div>
					</div>
				</div>	
			</section>
                        ...
                        <div class="row grid">
                            <div class="col-lg-4 col-md-6 col-sm-6 all breakfast">
                            	<div class="single-gallery">
                            		<img class="img-fluid" src="project/img/g1.jpg" alt="">
                            	</div>	                          
                            </div>                           
                            <div class="col-lg-4 col-md-6 col-sm-6 all dinner">
                            	<div class="single-gallery">
                            		<img class="img-fluid" src="project/img/g2.jpg" alt="">
                            	</div>                            
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6 all budget-meal">
                            	<div class="single-gallery">
                            		<img class="img-fluid" src="project/img/g3.jpg" alt="">
                            	</div>                            
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6 all breakfast">
                            	<div class="single-gallery">
                            		<img class="img-fluid" src="project/img/g4.jpg" alt="">
                            	</div>                            
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6 all lunch">
                            	<div class="single-gallery">
                            		<img class="img-fluid" src="project/img/g5.jpg" alt="">
                            	</div>                            
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6 all buffet">
                            	<div class="single-gallery">
                            		<img class="img-fluid" src="project/img/g6.jpg" alt="">
                            	</div>                            
                            </div>                            
                        </div>
                    </div>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6 single-blog">
							<div class="thumb">
								<img class="img-fluid" src="project/img/b1.jpg" alt="">								
							</div>
							<p class="date">6 Jul 2018</p>
							<a href="project/login.php"><h4>Cooking Perfect Fried Rice
							in minutes</h4></a>
							<p>
						...
						<div class="col-lg-3 col-md-6 col-sm-6 single-blog">
							<div class="thumb">
								<img class="img-fluid" src="project/img/b2.jpg" alt="">								
							</div>
							<p class="date">6 Jul 2018</p>
							<a href="project/login.php"><h4>Secret of making Heart 
							Shaped eggs</h4></a>
							<p>
						...
						<div class="col-lg-3 col-md-6 col-sm-6 single-blog">
							<div class="thumb">
								<img class="img-fluid" src="project/img/b3.jpg" alt="">								
							</div>
							<p class="date">6 Jul 2018</p>
							<a href="project/login.php"><h4>How to check steak if 
						...
						<div class="col-lg-3 col-md-6 col-sm-6 single-blog">
							<div class="thumb">
								<img class="img-fluid" src="project/img/b4.jpg" alt="">								
							</div>
							<p class="date">6 Jul 2018</p>
							<a href="project/login.php"><h4>Seaseme and black seed
					...
					<div class="container">
						<div class="row footer-bottom d-flex justify-content-between align-items-center">
							...
							<ul class="col-lg-4 col-mdcol-sm-6 -6 social-icons text-right">
	                            <li><a href="project/login.php"><i class="fa fa-facebook"></i></a></li>
	                            <li><a href="project/login.php"><i class="fa fa-twitter"></i></a></li>         
	                        </ul>
						</div>						
					</div>
				</div>
			...
			<script src="project/js/vendor/jquery-2.2.4.min.js"></script>
			<script src="project/js/popper.min.js"></script>
			<script src="project/js/vendor/bootstrap.min.js"></script>			
			<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>		
 			<script src="project/js/jquery-ui.js"></script>					
  			<script src="project/js/easing.min.js"></script>			
			<script src="project/js/hoverIntent.js"></script>
			<script src="project/js/superfish.min.js"></script>	
			<script src="project/js/jquery.ajaxchimp.min.js"></script>
			<script src="project/js/lightcase.js"></script>
			<script src="project/js/jquery.magnific-popup.min.js"></script>						
			...
			<script src="project/js/mail-script.js"></script>	
